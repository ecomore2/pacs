...
[here](https://github.com/ecomore2/pacs/blob/master/problems/dates.csv).
Go [here](https://raw.githubusercontent.com/ecomore2/pacs/master/problems/dates.csv)
if you want to copy and paste this CSV file to your computer.

After removing these `r nrow(problems)` cases with date problems as well as the `r nrow(no_dates)` cases and inferring the missing onset
dates from
